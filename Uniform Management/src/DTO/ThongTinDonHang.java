 ...
 * @author admin
 */
public class ThongTinDonHang implements Comparable<DonHang>{
    private String maDH;
    private String maKh;
    ...
    public ThongTinDonHang(String maDH, String maKh, String hoTen, String soDt, String diaChi, String ghiChu, String trangThai, double tongTien, String ngayDat, List<SanPham> listSp) {
        this.maDH = maDH;
        this.maKh = maKh;
        this.hoTen = hoTen;
        this.soDt = soDt;
    ...
    public int compareTo(DonHang o) {
        return Double.compare(this.getTongTien(),o.getTongTien());
    }
}
