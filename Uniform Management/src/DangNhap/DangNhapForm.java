...
public class DangNhapForm extends javax.swing.JFrame {
    ...
    LinkedHashSet<TaiKhoan> listTK = TaiKhoan.getTKNVList();
        ...
        for (TaiKhoan tk : listTK) {
            if (username.trim().equalsIgnoreCase(tk.getTenTK()) && password.trim().equalsIgnoreCase(tk.getMatKhau())) {
                ...
                if(tk.getRole().equals("1")){
                    ...
                    JOptionPane.showMessageDialog(this, "Chào mừng bạn đế với shop đồng phục", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
